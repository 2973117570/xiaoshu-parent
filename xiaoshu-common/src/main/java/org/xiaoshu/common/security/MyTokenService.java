package org.xiaoshu.common.security;
...
/**
 * 
 * 功能说明：自己重写的权限控制类，实现自己的TokenServer
 * 
 * MyTokenService.java
 * 
 * Original Author: deane.jia,2016年9月23日 上午9:25:40
 * 
...
public class MyTokenService implements AuthorizationServerTokenServices, ResourceServerTokenServices, ConsumerTokenServices, InitializingBean {
    ...
    private int accessTokenValiditySeconds = 12000;             //access_token 的超时时间   默认12个小时
